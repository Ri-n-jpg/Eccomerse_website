...
const Collection = () => {
  ...
  const toggleSubCategory = (e) => {
    if (subCategory.includes(e.target.value)) {
      ...
      setSubCategory(prev => [...prev, e.target.value]); // fixed typo
    }
  };
  ...
  const applyFilter = () => {
    ...
    setFilterProducts(productsCopy); // important
  };
  const sortProduct=()=>{
...
break;
  ...
  <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
    <div className='min-w-60'>
      ...
      <img
  className={`h-3 sm:hidden ${showFilter ? 'rotate-90' : ''}`}  src={assets.dropdown_icon}
  alt="dropdown"
/>
